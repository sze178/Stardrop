...
ingredient_data = {"Tia Maria" : {"flavor": "alcohol", "price": 4},
                   ...
                   'Orange Juice' : {"flavor": "fruit", "price": 2},
                   ...
                   'Pineapple Juice' : {"flavor": "fruit", "price": 2},
                   ...
                   'Grapefruit Juice' : {"flavor": "fruit", "price": 2},
                   ...
                   'Orange Peel' : {"flavor": "fruit", "price": 1},
                   'Coconut Milk' : {"flavor": "milk", "price": 2},
                   'Pineapple' : {"flavor": "fruit", "price": 3},
                   ...
                   'Lemonade' : {"flavor": "fruit", "price": 3},
                   'Water' : {"flavor": "other", "price": 1},
                   'Ginger' : {"flavor": "other", "price": 3},
                   'Guava juice' : {"flavor": "fruit", "price": 2},
                   ...
                   'Passion Fruit Juice' : {"flavor": "fruit", "price": 2},
                   'Ginger Ale' : {"flavor": "sweet", "price": 2},
                   'Soda Water' : {"flavor": "other", "price": 2},
                   'Mango' : {"flavor": "fruit", "price": 3},
                   'Orange' : {"flavor": "fruit", "price": 3},
                   'Apple Cider' : {"flavor": "fruit", "price": 2},
                   'Allspice' : {"flavor": "other", "price": 1},
                   'Nutmeg' : {"flavor": "other", "price": 1},
                   'Light Cream' : {"flavor": "milk", "price": 1},
                   'Egg White' : {"flavor": "milk", "price": 3},
                   'Coffee Liqueur' : {"flavor": "milk", "price": 2},
                   'Heavy Cream' : {"flavor": "milk", "price": 1},
                   'Chocolate Liqueur' : {"flavor": "milk", "price": 2},
                   'Amaretto' : {"flavor": "alcohol", "price": 4},
                   'Chocolate Sauce' : {"flavor": "milk", "price": 1},
                   'Salted Chocolate' : {"flavor": "sweet", "price": 1},
                   'Scotch' : {"flavor": "alcohol", "price": 4},
                   'Curacao' : {"flavor": "alcohol", "price": 4},
                   'Half-and-Half' : {"flavor": "milk", "price": 1},
                   'Condensed Milk' : {"flavor": "sweet", "price": 1},
                   'Coconut Syrup' : {"flavor": "sweet", "price": 1},
                   'Chocolate Syrup' : {"flavor": "milk", "price": 1},
                   'Kahlua' : {"flavor": "alcohol", "price": 4},
                   'Baileys Irish Cream' : {"flavor": "alcohol", "price": 4},
                   'Vanilla Ice-Cream' : {"flavor": "milk", "price": 2},
                   'Oreo cookie' : {"flavor": "sweet", "price": 2},
                   'Coffee' : {"flavor": "milk", "price": 2},
                   'Banana Liqueur' : {"flavor": "sweet", "price": 1},
                   'Creme De Cacao' : {"flavor": "milk", "price": 2},
                   'Chocolate Ice-Cream' : {"flavor": "milk", "price": 2},
                   'Chocolate Milk' : {"flavor": "milk", "price": 2},
                   'Whipped Cream' : {"flavor": "milk", "price": 1},
                   'Banana' : {"flavor": "fruit", "price": 3},
                   'Milk' : {"flavor": "milk", "price": 2},
                   'Vanilla' : {"flavor": "sweet", "price": 2},
                   'Chocolate' : {"flavor": "sweet", "price": 2},
                   'Espresso' : {"flavor": "milk", "price": 2},
                   'Egg Yolk' : {"flavor": "milk", "price": 3},
                   	"Sambuca" : {"flavor": "alcohol", "price": 4},
                    "Blackberries" : {"flavor": "fruit", "price": 3}}
...
def request_drink(id):
    if id == 0:
        return {"drink": "Surprise Me!", "ingredients": []}
